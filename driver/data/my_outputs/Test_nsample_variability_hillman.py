...
plt.plot(np.mean(I_LSCICE_novar,1)*1000,z,label='Grid mean with no variability')
plt.plot(np.mean(I_LSCICE_large,1)*1000,z,label='Grid mean with subgrid variability Hillman (1000 samples)')
